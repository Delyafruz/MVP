...
namespace HPhysic
{
    ...
    public class Connector : MonoBehaviour
    {
        ...
        public enum CableType { HDMI, TypeC, LAN }

        [field: Header("Settings")]

        [field: SerializeField] public ConType ConnectionType { get; private set; } = ConType.Male;
        [field: SerializeField] public CableType ConnectorType { get; private set; } = CableType.HDMI;
        ...
        [SerializeField] private GameObject connectorMesh;
        ...
        public bool IsConnectedRight => IsConnected && ConnectorType == ConnectedTo.ConnectorType;
        ...
        public bool CanConnect(Connector secondConnector) =>
            ...
            && this.ConnectorType == secondConnector.ConnectorType;
    }
}